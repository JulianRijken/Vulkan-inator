...
{
    SwapChainSupportDetails const SWAP_CHAIN_SUPPORT = QuerySwapChainSupport(m_PhysicalDevice);
    VkSurfaceFormatKHR const surfaceFormat = ChooseSwapSurfaceFormat(SWAP_CHAIN_SUPPORT.formats);
    VkPresentModeKHR const presentMode = ChooseSwapPresentMode(SWAP_CHAIN_SUPPORT.presentModes);
    VkExtent2D const extent = ChooseSwapExtent(SWAP_CHAIN_SUPPORT.capabilities);
